...
CREATE TABLE CTE_CABECALHO (
  ...
  SERIE CHAR(3)    ,
  NUMERO VARCHAR(9)    ,
  DATA_HORA_EMISSAO TIMESTAMP default NULL    ,
  ...
  TOMADOR INTEGER    ,
  DATA_ENTRADA_CONTINGENCIA TIMESTAMP default NULL    ,
  ...
  DATA_HORA_PROCESSAMENTO TIMESTAMP default NULL    ,
...
CREATE INDEX IFK_FK_CTE_INF_NF_TRANS_LACRE ON CTE_INF_NF_TRANSPORTE_LACRE (ID_CTE_INFORMACAO_NF_TRANSP);
...
CREATE TABLE NFE_CABECALHO (
  ...
  NUMERO VARCHAR(9)    ,
  DATA_HORA_EMISSAO TIMESTAMP default NULL    ,
  DATA_HORA_ENTRADA_SAIDA TIMESTAMP default NULL    ,
...
CREATE INDEX IFK_FK_NFE_CAB_PROD_LOTE ON PRODUTO_LOTE (ID_NFE_CABECALHO);
