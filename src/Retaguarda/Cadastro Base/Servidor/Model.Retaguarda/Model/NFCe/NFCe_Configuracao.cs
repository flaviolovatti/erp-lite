namespace Entity.Retaguarda.Model
{
    ...
    public partial class NFCe_Configuracao
    {
        ...
        {
            nfce_configuracao_balanca = new HashSet<NFCe_ConfiguracaoBalanca>();
            nfce_configuracao_leitor_ser = new HashSet<NFCe_ConfiguracaoLeitorSerial>();
        }
        ...
        public virtual ICollection<NFCe_ConfiguracaoBalanca> nfce_configuracao_balanca { get; set; }

        public virtual NFCe_Resolucao nfce_resolucao { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<NFCe_ConfiguracaoLeitorSerial> nfce_configuracao_leitor_ser { get; set; }
    }
}
